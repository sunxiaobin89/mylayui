...
layui.define('jquery', function(exports){
  ...
  ,util = {
    ...
    ,toDateString: function(time, format){
      ...
      .replace(/MM/g, that.digit(ymd[1]))
      .replace(/M/g, ymd[1])
      .replace(/dd/g, that.digit(ymd[2]))
      .replace(/d/g, ymd[2])
      .replace(/HH/g, that.digit(hms[0]))
      .replace(/H/g, hms[0])
      .replace(/hh/g, that.digit(hms[0] % 12))
      .replace(/h/g, hms[0] % 12)
      .replace(/mm/g, that.digit(hms[1]))
      .replace(/m/g, hms[1])
      .replace(/ss/g, that.digit(hms[2]))
      .replace(/s/g, hms[2]);
    }
