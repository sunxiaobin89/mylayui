...
;!function(win){
  ...
  ,modules = config.builtin = {
    ...
    ,tablePlug: 'tablePlug' //table功能加强扩展插件
    ,optimizeSelectOption: 'optimizeSelectOption' //table功能加强扩展插件
    ,laydatePro: 'laydatePro' //laydatePro功能加强扩展插件
  ...
  Layui.prototype.offevent = function(modName, events, callback){
    ...
    return Layui.event(modName, events, EV_REMOVE, callback);
  };
